...
public class ClassModule {
	...
	@FindBy(xpath = "//th[text()=' Status ']")	private WebElement statusHeader;
	@FindBy(xpath = "//th[text()=' Class Date ']")	private WebElement classDateHeader;
	@FindBy(xpath = "//th[text()=' Staff Name ']")	private WebElement staffNameHeader;
	@FindBy(css = ".p-paginator-current.ng-star-inserted")	private WebElement showingEnteries;
	@FindBy(xpath = "//p-sorticon[@field='batchName']")	private WebElement sortBatchNameBtn;
	@FindBy(className = "p-sortable-column-icon")	private List<WebElement> sortingBtn;
	@FindBy(css = "button[class='p-button-danger p-button p-component p-button-icon-only']")	private WebElement deleteBtnMC;

	// popup new window elements
	@FindBy(xpath = "//button[text()='Add New Class']")	private WebElement addNewClassBtn;
	@FindBy(xpath = "//button[@label='Cancel']")	private WebElement cancelBtn;
	@FindBy(xpath = "//button[@label='Save']")	private WebElement saveBtn;
	@FindBy(css = ".p-dialog-header-close")	private WebElement crossBtn;
	@FindBy(css = ".p-datatable-footer.ng-star-inserted")	private WebElement footer;
	@FindBy(xpath = "//label[text()='Batch Name']")	private WebElement batchNamePopup;
	@FindBy(xpath = "//label[text()='Class Topic ']")	private WebElement classTopicPopup;
	@FindBy(xpath = "//div[normalize-space()='Manage Class']")	private WebElement managePage;

	//Mandatory fields
	
	@FindBy(xpath = "//input[@placeholder='Select a Batch Name']")	private WebElement batchNameDrpdw;;
	@FindBy(xpath = "//input[@id='classTopic']")	private WebElement classTopic;
	@FindBy(xpath = "//input[@id='classDescription']")	private WebElement classDescription;
	@FindBy(xpath = "//input[@id='icon']") 	private WebElement datePicker;
	@FindBy(xpath = "//span[@class='p-button-icon pi pi-calendar']")	private WebElement calenderBtn;
	@FindBy(xpath = "//label[normalize-space()='Staff Name']")	private WebElement staffnameheader;
	@FindBy(className = "p-datepicker-month")	private WebElement month;
	@FindBy(className = "pi-chevron-right")	private WebElement nextMonth;
	@FindBy(xpath = "//span[normalize-space()='21']")	private WebElement date;
	@FindBy(xpath = "//td[@ng-reflect-ng-class='[object Object]']")	private List<WebElement> dateSel;
	@FindBy(xpath = "//input[@id='classNo']")	private WebElement noOfClasses;
	@FindBy(xpath = "//input[@placeholder='Select a Staff Name']")	private WebElement staffName;
	@FindBy(xpath = "//label[text()='No of Classes']")	private WebElement noOfClassesHeader;
	@FindBy(xpath = "//input[@ng-reflect-model]")	private WebElement noOfClassesTextBox;
	@FindBy(className = "p-radiobutton-box")	private WebElement statusActive;
	@FindBy(xpath = "(//div[@ng-reflect-ng-class='[object Object]'])[15]")	private WebElement statusInActive;
	@FindBy(xpath = "//p-dropdownitem[@class='ng-tns-c171-12 ng-star-inserted']")	private List<WebElement> batchNameList;
	@FindBy(id = "saveClass")	private WebElement saveAddClass;
	@FindBy(xpath = "//div[text()='Successful']")	private WebElement classCreated;

	// optional fields
	@FindBy(xpath = "//input[@id='classComments']")	private WebElement classComments;
	@FindBy(xpath = "//input[@id='classNotes']")	private WebElement notes;
	@FindBy(xpath = "//input[@id='classRecordingPath']")	private WebElement recording;
	
	// required fields
	@FindBy(xpath = "//small[normalize-space()='Batch Name is required.']")	private WebElement batchNameReq;
	@FindBy(xpath = "//small[normalize-space()='Class Topic is required.']")	private WebElement classTopicReq;
	@FindBy(xpath = "//small[normalize-space()='Class Date is required.']")	private WebElement classDateReq;
	@FindBy(xpath = "//small[normalize-space()='Staff Name is required.']")	private WebElement staffNameReq;
	@FindBy(xpath = "//small[normalize-space()='No. of Classes is required.']")	private WebElement noOfClassesReq;

	// Edit Window
	@FindBy(xpath = "//button[@icon='pi pi-pencil']")	private WebElement editBtn;
	@FindBy(xpath = "//div[@class='p-dialog-header ng-tns-c168-7 ng-star-inserted']")	private WebElement editPopup;
	...
	// Search box
	@FindBy(xpath = "//input[@id='filterGlobal']")	private WebElement searchBox;
