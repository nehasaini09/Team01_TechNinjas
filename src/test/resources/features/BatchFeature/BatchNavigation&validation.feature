Feature: Batch Page Navigation and Validation
  ...
  Scenario Outline: Validate datatable functionality
    When Admin clicks on the Batch menu from the header
    Then Admin should see "<datatable_functionality>"

    Examples:
      | datatable_functionality                             |
      | pagination controls under the data table            |
