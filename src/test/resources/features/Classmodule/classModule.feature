...
#Add new class popup window  
 ...
 Given clicks add new class under the class menu bar
    When Admin enters mandatory fields "<BatchName>" "<ClassTopic>" "<ClassDescription>" "<ClassDates>" "<StaffName>" "<Status>" "<SuccessMsg>" in the form and clicks on save button
   Then Admin gets message Class added Successfully
    Examples: 
    |BatchName||ClassTopic||ClassDescription||ClassDates|           |StaffName||Status||SuccessMsg|
    |SMPO10|    |Java|      |Core Java   |   |11/2/2024, 11/6/2024| |Sarnaya||Active||Successful|
    |SMPO2|     |@@|      |%^U^**&|        |12/4/2024|            |Geetha Thakur||Inactive||Unsuccessful|
